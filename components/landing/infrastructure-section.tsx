...
const regions = [
  { name: "North America", status: "Available" },
  { name: "Europe", status: "Available" },
  { name: "Asia Pacific", status: "Available" },
  { name: "Custom region", status: "On request" },
];
          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-stretch">
            ...
            <div className="flex flex-col justify-center">
              <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
                ...
                Built to
                <br />
                <span className="text-muted-foreground">scale with you.</span>
              </h2>

              <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg transition-all duration-1000 delay-100 ${
                isVisible ? "opacity-100" : "opacity-0"
              }`}>
                Deployed on Azure's global infrastructure — available across regions, ready to scale from one client to many.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-2 relative p-8 lg:p-12 border border-foreground/10 bg-foreground/[0.02] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <div className="flex flex-col mb-4">
                <span className="text-5xl lg:text-7xl font-display leading-tight">Azure's</span>
                <span className="text-2xl text-muted-foreground">global network</span>
              </div>
              <p className="text-muted-foreground max-w-md">
                Runs on Microsoft Azure's global data center network, giving you redundancy and low latency wherever your business operates.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className={`p-8 border border-foreground/10 bg-foreground/[0.02] transition-all duration-700 delay-200 ${
              ...
              <span className="text-5xl lg:text-6xl font-display">Low</span>
              <span className="block text-sm text-muted-foreground mt-2">Latency, powered by Azure's edge network</span>
            </div>
          </div>
        </div>
