...
const steps = [
  {
    ...
    description: "We map what data comes in, what needs to happen, and what 'done' looks like for your business.",
    code: `const workflow = new Workflow({
  input: 'customer-data',
  pipeline: ['extract', 'verify'],
  output: 'structured-export'
})`,
  },
  {
    number: "02",
    title: "Build",
    subtitle: "the agent",
    description: "Configured on Azure AI Foundry, connected to your documents, tools, and rules.",
    code: `const agent = new AzureAgent({
  foundryModel: 'gpt-4o',
  tools: ['docs', 'crm'],
  tenant: 'client-azure'
})`,
  },
  {
    ...
    title: "Deploy",
    subtitle: "& own it",
    description: "Deployed inside your own Azure tenant. Full visibility, full ownership, from day one.",
    code: `await agent.deploy({
  environment: 'client-cloud',
  ownership: '100%'
})`,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/10">Own.</span>
            </h2>
          </div>
