      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[140px] font-display tracking-tight leading-[0.95] transition-all duration-1000 ${
              ...
              What a
              <br />
              <span className="text-muted-foreground">run looks like.</span>
            </h2>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`lg:col-span-1 bg-foreground/[0.02] border border-foreground/10 p-10 lg:p-14 transition-all duration-700 ${
            ...
            <div className="text-lg text-foreground mb-2">To process one case</div>
            <div className="text-sm text-muted-foreground font-mono">start to finish</div>
          </div>

          {/* Metric 2 */}
          <div className={`bg-foreground/[0.02] border border-foreground/10 p-8 flex flex-col items-start justify-between gap-6 transition-all duration-700 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
          }`}>
            <div className="w-full">
              <div className="text-sm text-muted-foreground font-mono mb-2">Platform reliability</div>
              <div className="text-base text-foreground mb-3">Azure platform SLA</div>
              <DotGraph color="green" height={24} freq1={0.45} freq2={0.18} freqT={1.1} speed={0.032} baseline={0.4} amplitude={0.45} />
            </div>
          ...
          <div className={`bg-foreground/[0.02] border border-foreground/10 p-8 flex flex-col items-start justify-between gap-6 transition-all duration-700 ${
            ...
            <div className="w-full">
              <div className="text-sm text-muted-foreground font-mono mb-2">Delivery speed</div>
              <div className="text-base text-foreground mb-3">Minutes, not weeks</div>
              <DotGraph color="white" height={24} freq1={0.22} freq2={0.07} freqT={0.4} speed={0.015} baseline={0.25} amplitude={0.6} />
            </div>
            <div className="text-3xl md:text-4xl lg:text-5xl font-display tracking-tight w-full">
              Fast
            </div>
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span>Built on</span>
          <span className="text-foreground">Azure OpenAI Service</span>
          <span>Configurable per project</span>
        </div>
      </div>
    </section>
  );
