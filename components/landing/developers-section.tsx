...
const features = [
  { 
    title: "Custom-built", 
    description: "Configured to your exact workflow, not a one-size template"
  },
  { 
    title: "Transparent process", 
    description: "See exactly what the agent is doing at each step"
  },
  { 
    title: "Flexible backend", 
    description: "Built on Azure AI Foundry, model choice fits your needs"
  },
  { 
    title: "Tested before launch", 
    description: "Verified against real workflow samples before going live"
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9]">
            Built for you.
            <br />
            <span className="text-muted-foreground">Not by you.</span>
          </h2>
        </div>
